...
include "setting.php";
$queryGetJobs = isset($_SESSION['queryGetJobs']) ? $_SESSION['queryGetJobs'] :"SELECT * FROM jobs";
...
<body>
    ...
    <div id="mid">
        <div class="form-area">
            <form action="process_jobs.php" method="POST">
                <h2>Sort Jobs Tool</h2>
                <div class="topic-area">
                    <div class="topic-option">
                        <label class="form-heading" for="expectedSalary">Expected Salary (between 0 and 300,000):</label>
                        <input type="number" name="expectedSalary" id="expectedSalary" min="0" max="300000" placeholder="Set 0 to view all" required>
                    </div>
                    <div class="topic-option">
                        <p class="form-heading">Sort Direction</p>
                        <div class="sortDirection-area">
                            <div class="direction-option">
                                <input type="radio" id="sortASC" name="sortDirection" value="ASC" required>
        ...
        <div class="content-wrapper">
            ...
            <aside>
                <div class="aside-wrapper">
                    <?php 
                        $queryGetJobs = isset($_SESSION['asideQueryGetJobs']) ? 
                                        $_SESSION['asideQueryGetJobs'] 
                                        : "SELECT job_ref, job_title FROM jobs";
                        $result = mysqli_query($conn, $queryGetJobs);
                        if(!$result){
                            echo "<h1>Error querying database</h1>";
                        } elseif(mysqli_num_rows($result) == 0) {
    ...
    <footer>
        <p>&copy; 2024 TechForce Solutions. All rights reserved.</p><br>
